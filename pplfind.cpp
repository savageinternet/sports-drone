// from https://docs.opencv.org/3.4.1/db/db0/peopledetect_8cpp-example.html#_a0
...
static void detectAndDraw(const HOGDescriptor &hog, Mat &img)
{
    ...
    // hitThreshold is the third argument. default is 0
    // groupThreshold is the final argument. default is 2
